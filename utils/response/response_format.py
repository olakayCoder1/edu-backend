...
def error_response(message='An error occurred', group='BAD_REQUEST', status_code=400,data=None,errors=None):
    response_data = {'status': False, 'group': group, 'detail': message, 'message': message,"data":data , "errors":errors}
...
def success_response(data=None, message='Success',  status_code=200):
    response_data = {'status': True,'success': True,  'message': message,'detail': message,'data': data}
    return Response(response_data, status=status_code)
...
def bad_request_response(message='Bad Request', group='BAD_REQUEST',data=None,errors=None ,status_code=400):
    return error_response(message, group , status_code, data=data,errors=errors)
